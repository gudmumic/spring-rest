...
class BeerControllerTest {
    ...
    void setUp() {
        ...
        testBeerDTO = beerServiceImpl.getBeerList(null, false, ).get(0);
    }
    ...
    void getBeerList() throws Exception {
        ...
        given(beerService.getBeerList(null, false, )).willReturn(beerServiceImpl.getBeerList(null, false, ));

        mockMvc.perform(get(BeerController.BEER_PATH)
                .accept(String.valueOf(MediaType.APPLICATION_JSON)))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.length()", is(beerServiceImpl.getBeerList(null, false, ).size())));
    }
    ...
    void createNewBeer() throws Exception {
        ...
        given(beerService.createBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.getBeerList(null, false, ).get(1));
        ...
        mockMvc.perform(post(BeerController.BEER_PATH)
                ...
                .andExpect(jsonPath("$.id", is(beerServiceImpl.getBeerList(null, false, ).get(1).getId().toString())))
                .andExpect(jsonPath("$.name", is(beerServiceImpl.getBeerList(null, false, ).get(1).getName())));
    }
